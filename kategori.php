    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-tittle" id="kategoriBaruModalLabel">Tambah Kategori</h5>
                ...
                <div class="form-group">
                    ...
                    <?php } ?>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas-ban"></i>Close</button>
